...
<body>
    ...
    <form class="sub-form" method="POST" action="{{ route('password.store') }}">
        @csrf
        ...
        <div class="input-contain">
            ...
            <!-- Email Address -->
            <input type="email" name="email" placeholder="Enter your email" value="{{ old('email', $request->email) }}" required autofocus>
