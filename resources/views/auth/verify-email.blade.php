...
<body>
    ...
    <form class="sub-form" method="POST" action="{{ route('verification.send') }}">
        @csrf
        ...
        <div class="input-contain">
            ...
            <h2 class="info">Verify Email</h2>
            <p style="text-align: center; font-size: 14px; color: #4e3332;">
                Thanks for signing up! Please verify your email by clicking the link sent to your email address. If you didn’t receive the email, you can request another.
            </p>
    ...
    <form class="sub-form" method="POST" action="{{ route('logout') }}" style="margin-top: 20px;">
        @csrf
        <div class="input-contain">
            <div class="allsub">
