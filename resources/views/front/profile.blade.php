...
<form action="{{ route('front.profile_data') }}" method="POST" enctype="multipart/form-data" style="margin-top: 150px; margin-bottom:120px">
@csrf
@method('put')
...
<div class="row m-0">
    <div class="col-md-3">
        ...
        @php
            if($person->image) {
                $src = asset('images/'.$person->image->path);
            }else {
    ...
    <div class="col-md-9">
        ...
        <div class="mb-3">
            <label>Email</label>
            <input type="email" class="form-control" disabled value="{{$person->email}}">
        </div>
